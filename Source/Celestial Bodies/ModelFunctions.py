...
def CoupledTwoBody2DAnimPos(massList, ic, t0, tn, i, j, m1Name, m2Name):
    ...
    # Title and labels
    ax.set_title(f"2D Position Animation Of Coupled Bodies - {jDirection} vs. {iDirection}")
...
def CoupledTwoBody2DPlotVel(massList, ic, t0, tn, i, m1Name, m2Name):
    ...
    # Title and labels
    plt.title(f"2D Velocity Plot Of Coupled Bodies - {iVelocity} vs. Time")
...
def CoupledTwoBody2DAnimVel(massList, ic, t0, tn, i, m1Name, m2Name):
    ...
    # Title and labels
    ax.set_title(f"2D Velocity Animation Of Coupled Bodies - {iVelocity} vs. Time")
